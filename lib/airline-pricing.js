export const PRICING_VERSION = 'SH_PRICING_2026_09_V1';
...
const PAWAPAY_RAILS = new Set(['PawaPay', 'Orange Money', 'MTN Mobile Money', 'M-Pesa']);
...
export function calculateAirlinePricing({ providerFare, currency, ticketCount, paymentRail }) {
  ...
  // 150 bps is applied once to the processed subtotal, never recursively.
  const railFeeMinor = PAWAPAY_RAILS.has(normalizedRail) ? (subtotalMinor * 150n) / 10000n : 0n;
